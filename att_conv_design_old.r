# ..............................................................
# Multiattribute Conversion Function + Atttraciont
# ..............................................................

conversion_function_des <- function(ntest, 
                                    ntest_perver, 
                                    ntest_comp, 
                                    show_eachitem, 
                                    #items_task,
    ...
    if (choose(n_items, items_task) > 4000000) { # Changed Apr 2023
        ...
        if (nrow(task_code) > 100000) task_code <- task_code[sample(1:nrow(task_code),100000),] # sample 100k from all
    }
...
# Now do attraction
attraction_function_des <- function(conv_stack, show_eachitem_attraction){
